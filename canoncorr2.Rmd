...
For those that like who's spiel is to "Deep Dive", " Drill Deeper", peel the onion or get more granular. There are a couple of things left for you to do to "add value". 


We did not check if the correlations are significant. Actually quite important. 

Also we do not know how much of the correlation is explained by the different cannoncial dimensions. 
